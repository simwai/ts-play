...
Switch execution mode to `STRUCTURED` using `system/00-system.md` `## Execution modes`.
...
Declare `[PHASE: <phase>]` and follow the matching phase template from `system/03-output-and-state.md`.
